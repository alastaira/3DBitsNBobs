...
translate([-43/2,67.4/2])
linear_extrude(8)
difference(){
rect([43,67.4], rounding=[2,2,2,0]);
  rect([38.4,64], rounding=2);
 // #trapezoid(h=30, w1=39, w2=40, rounding=5);
}
...
mount_hole_spacing = 0;    // mount_hole_spacing between mounting holes. 31mm for LCD1602. 50mm for relay module
