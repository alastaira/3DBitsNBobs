...
linear_extrude(2)
  ...
  tube(id=8.1, od=10.1, h=5, anchor=BOTTOM);
}
...
linear_extrude(2)
  ...
  tube(id=5.08, od=7.08, h=5, anchor=BOTTOM);
}


/*

// https://www.aliexpress.com/item/1005008272525057.html
...
HANPOSE_35CD48_0805      = ["HANPOSE_35CD48_0805",        35, 60,       44/2, 30,    22/2,   2,     5,      24,          26,    [8,     8],    2,     true,  true,  0,       0];

    NEMA(HANPOSE_35CD48_0805);
