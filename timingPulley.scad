...
// Pulley properties
shaftDiameter = 5.2; // the shaft at the center, will be subtracted from the pulley. Better be too small than too wide.
hubDiameter = 12; // if the hub or timing pulley is big enough to fit a nut, this will be embedded.
hubHeight = 30; // the hub is the thick cylinder connected to the pulley to allow a set screw to go through or as a collar for a nut.
...
notchDepth = 0.2; // make it slightly bigger than actual, there's an outward curvature in the inner solid part of the pulley
